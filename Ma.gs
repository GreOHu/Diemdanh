...
function doGet(e) {
  ...
  if (action === 'getPositionSuggestions') {
    ...
    result = sendResponse(false, 'doGet chỉ hỗ trợ getPositionSuggestions / getDepartmentSuggestions / resolveMeetingCode / getMeetingConfigByID / getAttendanceList (JSONP). Các action khác dùng doPost().');
  }
